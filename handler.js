        ...
        case 'remove':
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    let pp = 'https://i.ibb.co/1ZxrXKJ/avatar-contat.jpg'
                    let ppgp = 'https://i.ibb.co/1ZxrXKJ/avatar-contat.jpg'
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Bienvenido, @user').replace('@group', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'Desconocido') :
                            ...
                            let wel = API('fgmods', '/api/welcome', {
                                ...
                                profile: pp,
                                background: 'https://i.imgur.om/bbWbASn.jpg'
                            }, 'apikey')
                            ...
                            let lea = API('fgmods', '/api/goodbye', {
                                ...
                                membercount: groupMetadata.participants.length,
                                profile: pp,
                                background: 'https://i.imgur.com/klTO3d.jpg'
                            }, 'apikey')
