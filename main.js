...
const connectionOptions = {
        ...
        printQRInTerminal: true,
        auth: state,
        browser: ['Queen-Shenali', 'Safari', '3.1.0'], 
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = 'bye @user'
  conn.spromote = '@user promote a admin'
  conn.sdemote = '@user your admin is removed'
  conn.sDesc = 'Group description \n@desc'
  conn.sSubject = 'The group name has been changed \n@group'
  conn.sIcon = 'Group icon changed'
  conn.sRevoke = 'Group invited link revoked \n@revoke'
